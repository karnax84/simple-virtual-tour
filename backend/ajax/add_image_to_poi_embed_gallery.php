...
$priority = 0;
$query = "SELECT MAX(priority)+1 as priority FROM svt_poi_embedded_gallery WHERE id_poi=$id_poi LIMIT 1;";
...
$query = "INSERT INTO svt_poi_embedded_gallery(id_poi,image,priority) VALUES(?,?,?);";
