...
if(isset($_FILES) && !empty($_FILES['file']['name'])){
    ...
    $name = "slider_".$milliseconds.".$ext";
    if($s3_enabled) {
        $path_dest = "s3://$s3_bucket_name/viewer/gallery/".$name;
    } else {
        $path_dest = dirname(__FILE__).'/../../viewer/gallery/'.$name;
    }
