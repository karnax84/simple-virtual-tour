...
if(isset($_FILES) && !empty($_FILES['file']['name'])){
    ...
    $name = "object360_".$milliseconds.".$ext";
    if($s3_enabled) {
        $path_dest = "s3://$s3_bucket_name/viewer/objects360/".$name;
    } else {
        $path_dest = dirname(__FILE__).'/../../viewer/objects360/'.$name;
    }
