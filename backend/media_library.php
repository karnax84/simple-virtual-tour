...
$can_create = get_plan_permission($id_user)['enable_media_library'];
...
<?php if(!$can_create) : ?>
    <div class="card bg-warning text-white shadow mb-4">
        <div class="card-body">
            <?php echo sprintf(_('Your "%s" plan not allow to create Media Library!'),$user_info['plan'])." ".$msg_change_plan; ?>
        </div>
    </div>
<?php exit; endif; ?>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($create_content) : ?><form action="ajax/upload_media_library_file.php" class="dropzone mb-3 noselect <?php echo ($demo || $disabled_upload) ? 'disabled' : ''; ?>" id="media-dropzone"></form><?php endif; ?>
                <div id="list_files">
