    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button <?php echo ($demo) ? 'disabled':''; ?> id="btn_save_caption" onclick="" type="button" class="btn btn-success"><?php echo _("Save"); ?></button>
                <button onclick="close_modal('modal_caption');" type="button" class="btn btn-secondary"><?php echo _("Close"); ?></button>
            </div>
        </div>
    </div>
</div>
