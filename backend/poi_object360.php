...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($upload_content) : ?><form action="ajax/upload_object360_image.php" class="dropzone mb-3" id="object360-dropzone"></form><?php endif; ?>
...
<script>
    (function($) {
        ...
        window.object360_images = [];
        Dropzone.autoDiscover = false;
        $(document).ready(function () {
            get_poi_object360_images(id_poi);
            if($('#object360-dropzone').length) {
                var gallery_dropzone = new Dropzone("#object360-dropzone", {
                    url: "ajax/upload_object360_image.php",
                    parallelUploads: 1,
                    maxFilesize: 20,
                    timeout: 120000,
                ...
                gallery_dropzone.on("success", function(file,rsp) {
                    add_image_to_poi_object360(id_poi,rsp);
                });
