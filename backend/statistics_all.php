                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div id="disk_space_used" class="h5 mb-0 font-weight-bold text-gray-800">
                            <button style="line-height:1;opacity:1" onclick="get_disk_space_stats(null,null);" class="btn btn-sm btn-primary p-1"><i class="fab fa-digital-ocean"></i> <?php echo _("analyze"); ?></button>
                        </div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-door-open"></i> <?php echo _("Top 10"); ?> - <?php echo _("Rooms Accesses"); ?></h6>
            </div>
            <div class="card-body p-2">
    ...
    <div class="col-md-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-stopwatch"></i> <?php echo _("Top 10"); ?> - <?php echo _("Rooms Permanence (seconds)"); ?></h6>
            </div>
            <div class="card-body p-2">
    ...
    <div class="col-md-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-eye"></i> <?php echo _("Top 10"); ?> - <?php echo _("POI views"); ?></h6>
            </div>
