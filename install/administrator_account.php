...
<head>
	...
	<link rel="stylesheet" type="text/css" href="templates/<?php echo EI_TEMPLATE; ?>/css/styles.css?v=3" />
	<?php
...
<div id="main">
	...
	<div id="content">
		...
		<div class="central-part">
            ...
            <p style='color:blue;'>These will be the credentials to log into the application as an administrator.</p>
			...
			<tr>
				...
				<td>
                    <input name="admin_username" id="admin_username" class="form_text" size="28" maxlength="64" value="<?php echo $admin_username; ?>" onfocus="textboxOnFocus('notes_admin_username')" onblur="textboxOnBlur('notes_admin_username')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="<?php if(EI_MODE == 'demo') echo 'demo: test'; ?>" />
                </td>
                ...
                <tr>
                    <td width="250px">&nbsp;<?php echo lang_key('admin_email'); ?>&nbsp;<span class="star">*</span></td>
                    <td>
                        <input name="admin_email" id="admin_email" class="form_text" size="28" maxlength="64" value="<?php echo $admin_email; ?>" onfocus="textboxOnFocus('notes_admin_email')" onblur="textboxOnBlur('notes_admin_email')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="<?php if(EI_MODE == 'demo') echo 'demo: test'; ?>" />
                    </td>
                </tr>
			<tr>
				<td>&nbsp;<?php echo lang_key('admin_password'); ?>&nbsp;<span class="star">*</span></td>
				<td>
                    <input name="admin_password" id="admin_password" class="form_text" type="password" size="28" maxlength="64" value="<?php echo $admin_password; ?>" onfocus="textboxOnFocus('notes_admin_password')" onblur="textboxOnBlur('notes_admin_password')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="<?php if(EI_MODE == 'demo') echo 'demo: test'; ?>" />
                </td>
			</tr>
