...
$arrLang['alert_unable_to_install'] = "Unable to install this application because an application with the same identity is already installed.";
...
$arrLang['admin_email_info'] = "Enter a valid email address";
$arrLang['admin_login'] = "Admin Username";
...
$arrLang['follow_the_wizard'] = "Follow the <b>Wizard</b> to install the application";
...
$arrLang['required_php_settings'] = "PHP Settings";
$arrLang['shell_exec'] = "Shell Exec";
